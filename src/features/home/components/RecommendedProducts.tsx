  ...
  return (
    <section className="mx-auto mt-stack-lg max-w-container-max px-margin-mobile md:px-margin-desktop">
      ...
      <div className="hide-scrollbar flex gap-gutter overflow-x-auto pb-6">
        <div className="product-card-hover group min-w-[240px] cursor-pointer overflow-hidden rounded-xl border border-outline-variant bg-white">
          <div className="relative aspect-square overflow-hidden bg-surface-container-low">
            ...
            />
            <div className="absolute top-2 left-2 rounded bg-primary-container px-2 py-0.5 text-[10px] font-bold text-white">
              ORGANIC
            </div>
          </div>
          <div className="p-3">
