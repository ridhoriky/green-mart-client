...
import { DealsCatalog } from '@/features/deals';
...
/**
 * Generate dynamic metadata for the Deals Page.
 *
 * @param props - The page props.
 * @returns The page metadata.
 */
export async function generateMetadata(props: DealsPageProps): Promise<Metadata> {
...
/**
 * Render fallback skeleton while Deals page is loading.
 *
 ...
 *
 * @param props - The page props.
 * @returns The deals page element.
 */
